...
const styles = StyleSheet.create({
  ...
  sectionNote: { color: '#8888aa', fontSize: 13, lineHeight: 18 },
  group: {
  ...
  groupSub: { color: '#5555aa', fontSize: 11, marginBottom: 8 },
  row: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  rowLabel: { color: '#e8e8f0', fontSize: 14, fontWeight: '500' },
  rowSub: { color: '#8888aa', fontSize: 11, marginTop: 2 },
});
